...
class Catalogo : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var gridView: GridView = findViewById(R.id.catalogoGridView)
...
class PeliculaAdapter: BaseAdapter{
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        val ivPelicula: ImageView = vista.findViewById(R.id.ivPelicula) as ImageView
        val tvTitulo: TextView = vista.findViewById(R.id.tvTitulo) as TextView
